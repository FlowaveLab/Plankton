...
SET
    ...
    actor_type = CASE
        ...
        WHEN action IN ('llm_suggestion_generated', 'llm_suggestion_failed', 'memory_evaluated') THEN 'llm'
...
BEGIN
    ...
    SET
        ...
        actor_type = CASE
            ...
            WHEN NEW.action IN ('llm_suggestion_generated', 'llm_suggestion_failed', 'memory_evaluated') THEN 'llm'
